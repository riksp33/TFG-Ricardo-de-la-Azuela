...
results = list(title = "Resultados de nivel del test para distintos tamaños muestrales. Normales")
...
dir_path = here('niveles', 'jsons')
full_path = file.path(dir_path,'tabla_1.json' )
