...
results = list(title = "Resultados de nivel del test para distintos tamaños muestrales. Gammas")
...
for (n in n_values) {
  ...
  for (i in 1:MC) {
    ...
    casos = rgamma(n, shape = 0.5, rate = 0.5)
...
full_path = file.path(dir_path,'tabla_3.json' )
