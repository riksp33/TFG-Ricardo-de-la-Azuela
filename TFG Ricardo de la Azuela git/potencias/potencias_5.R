...
results = list(title = "Resultados de potencia del test para distintos tamaños muestrales. Escenario 5")
...
full_path = file.path(dir_path,'potencias_5.json' )
