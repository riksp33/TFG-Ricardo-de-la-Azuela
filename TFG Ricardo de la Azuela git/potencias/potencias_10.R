...
results = list(title = "Resultados de potencia del test para distintos tamaños muestrales. Escenario 10")
...
for (n in n_values) {
  ...
  for (i in 1:MC) {
    ...
    casos = rgamma(n, shape = 0.35, rate = 1/8)
...
full_path = file.path(dir_path,'potencias_10.json' )
