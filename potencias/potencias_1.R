...
results = list(title = "Resultados de potencia del test para distintos tamaños muestrales. Escenario 1")
...
full_path = file.path(dir_path,'potencias_1.json' )
