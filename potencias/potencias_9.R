...
results = list(title = "Resultados de potencia del test para distintos tamaños muestrales. Escenario 9")
...
for (n in n_values) {
  ...
  for (i in 1:MC) {
    ...
    casos = rgamma(n, shape = 3.28, rate = 4)
...
full_path = file.path(dir_path,'potencias_9.json' )
